...
export default function AboutMe () {
  return (
    ...
    <div className="about-me__info">
       ...
       <p className="about-me__discription">Я родился и живу в Брянске, закончил строительный факультет  БГИТУ. Я люблю слушать музыку, а ещё увлекаюсь бегом. Недавно начал кодить. С 2021 года работал в компании «СКБ Контур». После того, как прошёл курс по веб-разработке, начал заниматься фриланс-заказами и ушёл с постоянной работы.</p>
